...
export function IndianismConverter() {
  const { accent } = useApp();
  const filtered = indianisms.filter((i) => i.accent === accent);
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Side-by-side instant correction cards converting literal translations into natural native phrasing."
